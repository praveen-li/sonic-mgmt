...
sensors test suite from sensors_facts. Without this module user has to go 
through tedious process for creating this Meta data Manually.

description:
    - sensors_raw input dictionary defines field which will be part of sonic 
      meta data.
    - create a predefined format similar to file sku-sensors-data.ymlfor result 
      dictionary.
